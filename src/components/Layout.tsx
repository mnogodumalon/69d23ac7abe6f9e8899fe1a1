...
import { IconAlertCircle, IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMapPin, IconMenu2, IconSquareCheck } from '@tabler/icons-react';
...
const APP_TITLE = 'Hochzeitsplaner';
...
const navigation = [
  ...
  { name: 'Hochzeitsdetails', href: '/hochzeitsdetails', icon: IconFileText },
  { name: 'Locations', href: '/locations', icon: IconMapPin },
  { name: 'Dienstleister', href: '/dienstleister', icon: IconFileText },
  { name: 'Gästeliste', href: '/gaesteliste', icon: IconFileText },
  { name: 'Budgetplanung', href: '/budgetplanung', icon: IconFileText },
  { name: 'Zeitplan & Ablauf', href: '/zeitplan-&-ablauf', icon: IconFileText },
  { name: 'Aufgaben & To-Dos', href: '/aufgaben-&-to-dos', icon: IconSquareCheck },
  { name: 'Tischplan', href: '/tischplan', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Hochzeitsdetails', href: '/gateway/apps/69d23a8e89c5177deacbdebc?template=list_page', icon: IconFileText },
  { name: 'Locations', href: '/gateway/apps/69d23a935dd994ff99fee8eb?template=list_page', icon: IconMapPin },
  { name: 'Dienstleister', href: '/gateway/apps/69d23a9451738ee4cd0b187d?template=list_page', icon: IconFileText },
  { name: 'Gästeliste', href: '/gateway/apps/69d23a9578db530f545cb88a?template=list_page', icon: IconFileText },
  { name: 'Budgetplanung', href: '/gateway/apps/69d23a96cb929938e4f78841?template=list_page', icon: IconFileText },
  { name: 'Zeitplan & Ablauf', href: '/gateway/apps/69d23a978de260826ade5809?template=list_page', icon: IconFileText },
  { name: 'Aufgaben & To-Dos', href: '/gateway/apps/69d23a989e9072af0f038f40?template=list_page', icon: IconSquareCheck },
  { name: 'Tischplan', href: '/gateway/apps/69d23a988247f96f9b95d80a?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69d23a8e89c5177deacbdebc?template=list_page"
